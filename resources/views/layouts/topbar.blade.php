        ...
        <ul class="nav-right">
            ...
            <li class="dropdown dropdown-animated scale-left">
                ...
                <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                    ...
                    <a href="{{ url('settings') }}" class="dropdown-item d-block p-h-15 p-v-10">
                    ...
                    <a href="{{ route('logout') }}" class="dropdown-item d-block p-h-15 p-v-10" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
